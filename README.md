...
| ✨ new | [Observatorio Adolescentes & Pantallas 📱](https://github.com/unimauro/observatorio-smartphones-adolescentes) · [live demo](https://unimauro.github.io/observatorio-smartphones-adolescentes/) | Public research dashboard consolidating scientific evidence and open data on adolescents' smartphone, social-media and internet use: world panorama (interactive map), mental health (correlations), education, digital risks, family, LATAM & Peru focus, a DOI-indexed library and a researcher export (CSV/JSON). Anti-overclaiming: correlation ≠ causation, sources cited. | ![React](https://img.shields.io/badge/-React-61DAFB?style=flat-square&logo=react&logoColor=black) ![TypeScript](https://img.shields.io/badge/-TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) ![ECharts](https://img.shields.io/badge/-ECharts-AA344D?style=flat-square&logo=apacheecharts&logoColor=white) ![Leaflet](https://img.shields.io/badge/-Leaflet-199900?style=flat-square&logo=leaflet&logoColor=white) |
