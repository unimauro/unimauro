...
|---|---------|-------------|------|
| ✨ new | [Suyay · Coach UNI-FIIS 🌱](https://github.com/unimauro/agente-uni-demo) · [live demo](https://unimauro.github.io/agente-uni-demo/) | Interactive demo of a WhatsApp academic coach agent for engineering students at UNI, built with Claude: grade lookup, "what do I need to pass" calculation, exam reminders and empathetic support (including the last-chance TRICA case). Client-side simulated replies, no real data. | ![Claude](https://img.shields.io/badge/-Claude-D97757?style=flat-square&logo=anthropic&logoColor=white) ![JavaScript](https://img.shields.io/badge/-JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black) |
